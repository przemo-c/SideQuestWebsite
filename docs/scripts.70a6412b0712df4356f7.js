...
"undefined" == typeof jQuery &&
              ...
              f.isString(e)
                ...
                : (n =
                    f.isArray(e) && 1 === e.length
                      ...
                      : !(!f.isArray(e) || 4 !== e.length) && a.apply(null, e)),
              !1 === n &&
                (n = m.Easings[m.defaults.easing] ? m.defaults.easing : g),
              n
            );
          }
          function l(e) {
            if (e) {
              ...
              for (var o = 0; n > o; o++)
                if (m.State.calls[o]) {
                  var a = m.State.calls[o],
                    s = a[0],
                    d = a[2],
                    p = a[3],
                    h = !!p,
                    v = null;
                  p || (p = m.State.calls[o][3] = t - 16);
                  for (
                    var g = Math.min((t - p) / d.duration, 1),
                      y = 0,
                      w = s.length;
                    w > y;
                    y++
                      ...
                      k))
                        if ("element" !== S) {
                          ...
                          if (((E.currentValue = A), "tween" === S)) v = A;
                            ...
                            b.Hooks.registered[S] &&
                              (r(C).rootPropertyValueCache[D] = b.Normalizations
                                .registered[D]
                                ? b.Normalizations.registered[D](
                                    "extract",
                                    null,
                                    j[1]
                                  )
            ...
            for (
              ...
              if (
                (t ||
                  a.loop ||
                  ("none" === a.display &&
                    b.setPropertyValue(p, "display", a.display),
                  "hidden" === a.visibility &&
                    b.setPropertyValue(p, "visibility", a.visibility)),
                !0 !== a.loop &&
                  (u.queue(p)[1] === i ||
              ...
              s && !0 !== a.loop && s(o),
                r(p) &&
                  !0 === a.loop &&
                  !t &&
                  (u.each(r(p).tweensContainer, function(e, t) {
                    /^rotate/.test(e) &&
                  ...
                  m(p, "reverse", { loop: !0, delay: a.delay })),
                !1 !== a.queue && u.dequeue(p, a.queue);
            }
            m.State.calls[e] = !1;
            for (var h = 0, v = m.State.calls.length; v > h; h++)
          ...
          if (!(7 >= d)) {
            ...
            var b = (m.CSS = {
              ...
              Hooks: {
                ...
                registered: {},
                register: function() {
                  for (o = 0; o < b.Lists.colors.length; o++)
                    b.Hooks.templates[b.Lists.colors[o]] = [
                      "Red Green Blue Alpha",
                      "color" === b.Lists.colors[o]
                        ? "0 0 0 1"
                        : "255 255 255 1"
                    ];
                  var e, t, n;
                  if (d)
                    for (e in b.Hooks.templates) {
                      n = (t = b.Hooks.templates[e])[0].split(" ");
                      var i = t[1].match(b.RegEx.valueSplit);
                      "Color" === n[0] &&
                        (n.push(n.shift()),
                        i.push(i.shift()),
                        (b.Hooks.templates[e] = [n.join(" "), i.join(" ")]));
                    }
                  for (e in b.Hooks.templates)
                    for (var o in (n = (t = b.Hooks.templates[e])[0].split(
                      " "
                    )))
                      b.Hooks.registered[e + n[o]] = [e, o];
                },
                getRoot: function(e) {
                ...
                extractValue: function(e, t) {
                  ...
                  if (n) {
                    var i = n[1];
                    return (t = b.Hooks.cleanRootPropertyValue(n[0], t))
                      .toString()
                      .match(b.RegEx.valueSplit)[i];
                  }
                  return t;
                },
                injectValue: function(e, t, n) {
                  ...
                  if (i) {
                    var o,
                      r = i[1];
                    return (
                      ((o = (n = b.Hooks.cleanRootPropertyValue(i[0], n))
                        .toString()
                ...
                registered: {
                  clip: function(e, t, n) {
                    switch (e) {
                      ...
                      case "extract":
                        var i;
                        return b.RegEx.wrappedValueAlreadyExtracted.test(n)
                          ? n
                          : (i = n.toString().match(b.RegEx.valueUnwrap))
                          ? i[1].replace(/,(\s+)?/g, " ")
                          : n;
                      case "inject":
                        return "rect(" + n + ")";
              ...
              Names: {
                ...
                SVGAttribute: function(e) {
                  ...
                  return (
                    (d || (m.State.isAndroid && !m.State.isChrome)) &&
                      (t += "|transform"),
                ...
                prefixCheck: function(e) {
                  ...
                  for (
                    ...
                    if (
                      ...
                      f.isString(m.State.prefixElement.style[o]))
                    )
                      return (m.State.prefixMatches[e] = o), [o, !0];
                  }
                  return [e, !1];
                }
              },
              ...
              getPropertyValue: function(e, n, o, a) {
                ...
                if (b.Hooks.registered[n]) {
                  ...
                  var f, h;
                  "transform" !==
                    (f = b.Normalizations.registered[n]("name", e)) &&
                    ((h = s(e, b.Names.prefixCheck(f)[0])),
                    b.Values.isCSSNullValue(h) &&
                      b.Hooks.templates[n] &&
                      (h = b.Hooks.templates[n][1])),
                    (l = b.Normalizations.registered[n]("extract", e, h));
                }
                if (!/^[\d-]/.test(l))
              ...
              setPropertyValue: function(e, n, i, o, a) {
                ...
                if ("scroll" === n)
                  ...
                  "transform" === b.Normalizations.registered[n]("name", e)
                )
                  ...
                  if (
                    (b.Normalizations.registered[n] &&
                      ((i = b.Normalizations.registered[n]("inject", e, i)),
                    ...
                    r(e) && r(e).isSVG && b.Names.SVGAttribute(n)
                      ? e.setAttribute(n, i)
                      : (e.style[s] = i);
                  m.debug >= 2 &&
              ...
              (m.hook = function(e, t, n) {
                ...
                return (
                  ...
                  u.each(e, function(e, o) {
                    if ((r(o) === i && m.init(o), n === i))
                      a === i && (a = m.CSS.getPropertyValue(o, t));
                    else {
                      var s = m.CSS.setPropertyValue(o, t, n);
            ...
            var w = function() {
              ...
              function a() {
                function e(e) {
                  function p(e, t) {
                    ...
                    return (
                      f.isArray(e)
                        ...
                        : (n = e),
                      t || (o = o || c.easing),
                      f.isFunction(n) && (n = n.call(a, T, C)),
                      f.isFunction(r) && (r = r.call(a, T, C)),
                      [n || 0, o, r]
                    );
                  }
                  function h(e, t) {
                  ...
                  if ("scroll" === A) {
                    var v,
                      w,
                      k,
                      S = /^x$/i.test(c.axis) ? "Left" : "Top",
                      P = parseFloat(c.offset) || 0;
                    c.container
                      ? f.isWrapped(c.container) || f.isNode(c.container)
                        ? ((c.container = c.container[0] || c.container),
                          (k =
                            (v = c.container["scroll" + S]) +
                            u(a).position()[S.toLowerCase()] +
                            P))
                        : (c.container = null)
                      : ((v =
                          m.State.scrollAnchor[m.State["scrollProperty" + S]]),
                        (w =
                          m.State.scrollAnchor[
                            m.State[
                    ...
                    (M = u.extend(!0, {}, r(a).tweensContainer))))
                      if ("element" !== O) {
                        var D = M[O].startValue;
                        (M[O].startValue = M[O].currentValue = M[O].endValue),
                          (M[O].endValue = D),
                          f.isEmptyObject(x) || (M[O].easing = c.easing),
                          m.debug &&
                            console.log(
                    ...
                    y)) {
                      ...
                      var z = b.Hooks.getRoot(N),
                        $ = !1;
                      if (
                        r(a).isSVG ||
                        "tween" === z ||
                        !1 !== b.Names.prefixCheck(z)[1] ||
                        b.Normalizations.registered[z] !== i
                      ) {
                        ((c.display !== i &&
                          null !== c.display &&
                          "none" !== c.display) ||
                          (c.visibility !== i && "hidden" !== c.visibility)) &&
                          /opacity|filter/.test(N) &&
                          !H &&
                          0 !== L &&
                          (H = 0),
                          c._cacheValues && M && M[N]
                            ? (H === i && (H = M[N].endValue + M[N].unitType),
                              ($ = r(a).rootPropertyValueCache[z]))
                            : b.Hooks.registered[N]
                            ? H === i
                              ? (($ = b.getPropertyValue(a, z)),
                                (H = b.getPropertyValue(a, N, $)))
                              : ($ = b.Hooks.templates[z][1])
                            : H === i && (H = b.getPropertyValue(a, N));
                        var V,
                          W,
                          R,
                          F = !1;
                  ...
                  d.element &&
                    (b.Values.addClass(a, "velocity-animating"),
                    q.push(d),
                    "" === c.queue &&
                      ((r(a).tweensContainer = d), (r(a).opts = c)),
                    (r(a).isAnimating = !0),
                    T === C - 1
                      ? (m.State.calls.push([q, g, c, null, E.resolver]),
                        !1 === m.State.isTicking &&
                ...
                var o,
                  a = this,
                  c = u.extend({}, m.defaults, x),
                  d = {};
                switch (
                  (r(a) === i && m.init(a),
                  parseFloat(c.delay) &&
                    !1 !== c.queue &&
                    u.queue(a, c.queue, function(e) {
                ...
                !1 !== m.mock &&
                  (!0 === m.mock
                    ...
                    : ((c.duration *= parseFloat(m.mock) || 1),
                      (c.delay *= parseFloat(m.mock) || 1))),
                  (c.easing = s(c.easing, c.duration)),
                  c.begin && !f.isFunction(c.begin) && (c.begin = null),
                  c.progress &&
                    !f.isFunction(c.progress) &&
                    (c.progress = null),
                  c.complete &&
                    !f.isFunction(c.complete) &&
                    (c.complete = null),
                  c.display !== i &&
                    null !== c.display &&
                    ((c.display = c.display.toString().toLowerCase()),
                    "auto" === c.display &&
                      (c.display = m.CSS.Values.getDisplayType(a))),
                  c.visibility !== i &&
                    null !== c.visibility &&
                    (c.visibility = c.visibility.toString().toLowerCase()),
                  (c.mobileHA =
                    c.mobileHA && m.State.isMobile && !m.State.isGingerbread),
                  !1 === c.queue
                    ? c.delay
                      ? setTimeout(e, c.delay)
                      : e()
                    : u.queue(a, c.queue, function(t, n) {
                        return !0 === n
                          ? (E.promise && E.resolver(g), !0)
                          : ((m.velocityQueueEntryFlag = !0), void e(t));
                      }),
                  ("" !== c.queue && "fx" !== c.queue) ||
                    "inprogress" === u.queue(a)[0] ||
                    u.dequeue(a);
              }
              var d,
                p,
              ...
              if (
                ...
                k
                  ...
                  : ((y = arguments[h]), (x = arguments[h + 1]));
                var C = g.length,
                  T = 0;
                if (!/^(stop|finish)$/i.test(y) && !u.isPlainObject(x)) {
                  x = {};
                  for (var S = h + 1; S < arguments.length; S++)
                    f.isArray(arguments[S]) ||
                    (!/^(fast|normal|slow)$/i.test(arguments[S]) &&
                      !/^\d/.test(arguments[S]))
                      ? f.isString(arguments[S]) || f.isArray(arguments[S])
                        ? (x.easing = arguments[S])
                        : f.isFunction(arguments[S]) &&
                          (x.complete = arguments[S])
                      : (x.duration = arguments[S]);
                }
                var A,
                ...
                switch (
                  (d &&
                    m.Promise &&
                    (E.promise = new m.Promise(function(e, t) {
                  ...
                  case "stop":
                    ...
                    var P = [];
                    return (
                      u.each(m.State.calls, function(e, t) {
                        t &&
                          u.each(t[1], function(n, o) {
                            var a = x === i ? "" : x;
                            return (
                              (!0 !== a &&
                                t[2].queue !== a &&
                                (x !== i || !1 !== t[2].queue)) ||
                              void u.each(g, function(n, i) {
                                i === o &&
                                  ((!0 === x || f.isString(x)) &&
                                    (u.each(
                                      u.queue(i, f.isString(x) ? x : ""),
                                      function(e, t) {
                                  ...
                                  "stop" === y
                                    ? (r(i) &&
                                        r(i).tweensContainer &&
                                        !1 !== a &&
                                        u.each(r(i).tweensContainer, function(
                                          e,
                                          t
                                        ) {
                  ...
                  default:
                    if (!u.isPlainObject(y) || f.isEmptyObject(y)) {
                      if (f.isString(y) && m.Redirects[y]) {
                        var O = (_ = u.extend({}, x)).duration,
                          D = _.delay || 0;
                        return (
                          !0 === _.backwards &&
            ...
            return (
              ...
              (e.Velocity = m),
              e !== t &&
                ((e.fn.velocity = w), (e.fn.velocity.defaults = m.defaults)),
              u.each(["Down", "Up"], function(e, t) {
                m.Redirects["slide" + t] = function(e, n, o, r, a, s) {
                  var l = u.extend({}, n),
                    c = l.begin,
                    d = l.complete,
                    p = {
                  ...
                  l.display === i &&
                    ...
                    (l.begin = function() {
                      for (var n in (c && c.call(a, a), p)) {
                        f[n] = e.style[n];
                        var i = m.CSS.getPropertyValue(e, n);
                        p[n] = "Down" === t ? [i, 0] : [0, i];
                      }
              ...
              u.each(["In", "Out"], function(e, t) {
                m.Redirects["fade" + t] = function(e, n, o, r, a, s) {
                  var l = u.extend({}, n),
                    c = { opacity: "In" === t ? 1 : 0 },
                    d = l.complete;
                  (l.complete =
  ...
  (function(e, t, n, i) {
    ...
    function d(e, t) {
      return typeof e == K ? e.apply((t && t[0]) || i, t) : e;
    }
    function p(e, t) {
      return e === i ? t : e;
    }
    ...
    function x(e, t) {
      for (
        ...
        if ((o = (n = Z[a]) ? n + r : t) in e) return o;
        a++;
      }
      return i;
    }
      ...
      (n.isFirst = !!r),
        ...
        (function(e, t) {
          ...
          (t.timeStamp = ne()),
            ...
            (t.scale = a
              ? (function(e, t) {
                  return O(i[0], i[1], ke) / O(e[0], e[1], ke);
                })(a.pointers)
              : 1),
            (t.rotation = a
              ? (function(e, t) {
                  return D(i[1], i[0], ke) - D(e[1], e[0], ke);
                })(a.pointers)
              : 0),
            S(n, t);
          var c = e.element;
    ...
    function S(e, t) {
      ...
      if (t.eventType != pe && (l > ce || s.velocity === i)) {
        var c = s.deltaX - t.deltaX,
          u = s.deltaY - t.deltaY,
          d = { x: c / l || 0, y: u / l || 0 };
        (o = d.x),
          (r = d.y),
          (n = te(d.x) > te(d.y) ? d.x : d.y),
          (a = P(c, u)),
          (e.lastInterval = t);
      } else
        (n = s.velocity),
    ...
    function A(e) {
      for (var t = [], n = 0; n < e.pointers.length; )
        (t[n] = {
          clientX: ee(e.pointers[n].clientX),
          clientY: ee(e.pointers[n].clientY)
        }),
          n++;
      return {
        timeStamp: ne(),
    ...
    function _() {
      ...
      (this.touch = new N(this.manager, e)),
    ...
    function B(e, t) {
      return (
        ((t = t || {}).recognizers = p(t.recognizers, B.defaults.preset)),
        new Y(e, t)
      );
    }
    function Y(e, t) {
      (this.options = l((t = t || {}), B.defaults)),
        ...
        (this.input = (function(e) {
          return new (e.options.inputClass || (re ? j : ae ? N : oe ? _ : M))(
            e,
            T
          );
        })(this)),
    ...
    var Z = ["", "webkit", "moz", "MS", "ms", "o"],
      ...
      ne = Date.now,
      ie = 1,
      oe = "ontouchstart" in e,
      re = x(e, "PointerEvent") !== i,
      ae =
        oe && /mobile|tablet|ip(ad|hone|od)|android/i.test(navigator.userAgent),
      se = "touch",
      le = "mouse",
      ce = 25,
      ue = 1,
    ...
    var Ce = { mousedown: ue, mousemove: 2, mouseup: de },
      Te = "mousedown",
      ...
      c(j, C, {
        handler: function(e) {
          var t = this.store,
            ...
            o = Ae[i],
            r = Ee[e.pointerType] || e.pointerType,
            a = r == se,
    ...
    var De = { touchstart: ue, touchmove: 2, touchend: de, touchcancel: pe },
      Me = "touchstart",
      ...
      handler: function(e) {
        ...
        if ((t === ue && (this.started = !0), this.started)) {
          var n = function(e, t) {
            ...
            return (
              t & (de | pe) && (n = w(n.concat(i), "identifier", !0)), [n, i]
            );
          }.call(this, e, t);
          t & (de | pe) &&
    ...
    var qe = { touchstart: ue, touchmove: 2, touchend: de, touchcancel: pe },
    ...
    c(N, C, {
          ...
          n = function(e, t) {
            ...
            for (o = 0; o < a.length; )
              i[a[o].identifier] && s.push(a[o]),
                t & (de | pe) && delete i[a[o].identifier],
                o++;
      ...
      c(_, C, {
        handler: function(e, t, n) {
          var i = n.pointerType == le;
          if (n.pointerType == se) this.mouse.allow = !1;
          else if (i && !this.mouse.allow) return;
          t & (de | pe) && (this.mouse.allow = !0), this.callback(e, t, n);
        },
        destroy: function() {
          this.touch.destroy(), this.mouse.destroy();
        }
      });
    var _e = x(J.style, "touchAction"),
      Le = _e !== i,
      Ie = "compute",
      He = "manipulation",
      ze = "none",
    ...
    L.prototype = {
      set: function(e) {
        e == Ie && (e = this.compute()),
          Le && (this.manager.element.style[_e] = e),
    ...
    (I.prototype = {
      ...
      recognizeWith: function(e) {
        ...
        return (
          t[(e = z(e, this)).id] || ((t[e.id] = e), e.recognizeWith(this)), this
        );
      },
      ...
      requireFailure: function(e) {
        ...
        return (
          -1 === y(t, (e = z(e, this))) && (t.push(e), e.requireFailure(this)),
          this
        );
      },
      ...
      canEmit: function() {
        for (var e = 0; e < this.requireFail.length; ) {
          if (!(this.requireFail[e].state & (32 | We))) return !1;
          e++;
        }
        return !0;
      },
      recognize: function(e) {
        ...
        return d(this.options.enable, [this, t])
          ? (this.state & (Qe | Be | 32) && (this.state = We),
            (this.state = this.process(t)),
            void (this.state & (Re | Fe | Xe | Be) && this.tryEmit(t)))
      ...
      c(V, $, {
        ...
        getTouchAction: function() {
          var e = this.options.direction,
            t = [];
          return e & ye && t.push(Ve), e & be && t.push($e), t;
        },
        ...
        attrTest: function(e) {
          return (
            $.prototype.attrTest.call(this, e) &&
            (this.state & Re || (!(this.state & Re) && this.directionTest(e)))
          );
        },
        emit: function(e) {
      ...
      c(W, $, {
        ...
        attrTest: function(e) {
          return (
            ...
            (Math.abs(e.scale - 1) > this.options.threshold || this.state & Re)
          );
        },
        emit: function(e) {
          this._super.emit.call(this, e),
      ...
      c(R, I, {
        ...
        process: function(e) {
          ...
          if (((this._input = e), !i || !n || (e.eventType & (de | pe) && !r)))
            this.reset();
          else if (e.eventType & ue)
            this.reset(),
              (this._timer = o(
                function() {
          ...
          else if (e.eventType & de) return Qe;
          return 32;
        },
        reset: function() {
      ...
      c(F, $, {
        ...
        attrTest: function(e) {
          return (
            this._super.attrTest.call(this, e) &&
            (Math.abs(e.rotation) > this.options.threshold || this.state & Re)
          );
        }
      }),
      c(X, $, {
      ...
      c(Q, I, {
        ...
        process: function(e) {
          var t = this.options,
            ...
            i = e.distance < t.threshold,
            r = e.deltaTime < t.time;
          if ((this.reset(), e.eventType & ue && 0 === this.count))
        ...
        recognize: function(e) {
          ...
          if (!t.stopped) {
            ...
            var n,
              i = this.recognizers,
              o = t.curRecognizer;
            (!o || (o && o.state & Qe)) && (o = t.curRecognizer = null);
            for (var r = 0; r < i.length; )
              (n = i[r]),
                2 === t.stopped || (o && n != o && !n.canRecognizeWith(o))
                  ? n.reset()
                  : n.recognize(e),
                !o && n.state & (Re | Fe | Xe) && (o = t.curRecognizer = n),
                r++;
          }
        },
        get: function(e) {
